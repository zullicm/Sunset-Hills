...
## React-Calendar & moment.js

Used React-Calendar to make picking dates for reservations easy.

npm install react-calendar

moment.js was used for creating min and max dates on the calendar, as well as some better date formatting
